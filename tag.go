...
// NewWithCoder creates a new tag manager with a coder
...
// Addf creates a new tag with a format
...
// AddRandf creates a new tag with random color and format
